...
public class NaviDrawer extends Div
    ...
    private void initHeader() {
        mainContent.add(getBrandExpression());
    }

    protected BrandExpression getBrandExpression() {
        return new BrandExpression("vaadin-starter");
    }
    ...
    protected NaviMenu createMenu() {
        return new NaviMenu();
    }

    private void initFooter() {
        railButton = UIUtils.createSmallButton(getTranslation("collapse"), VaadinIcon.CHEVRON_LEFT_SMALL);
    ...
    private void toggleRailMode() {
        if (getElement().hasAttribute(RAIL)) {
            ...
            railButton.setText(getTranslation("collapse"));
            ...
            railButton.setText(getTranslation("expand"));
