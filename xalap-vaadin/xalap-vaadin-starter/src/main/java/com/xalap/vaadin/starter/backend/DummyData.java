...
public class DummyData {
    ...
    private static final Map<String, String> HEALTHCARE = new HashMap<>();
    private static final Map<String, String> DENTAL = new HashMap<>();
    private static final Map<String, String> CONSTRUCTION = new HashMap<>();
