...
package com.xalap.vaadin.starter.ui;
...
import com.xalap.vaadin.starter.custom.ErrorHandlerProvider;
...
import com.xalap.vaadin.starter.ui.components.navigation.bar.TabBar;
...
import com.xalap.vaadin.starter.ui.util.css.Overflow;
...
//@PWA(name = "vaadin-starter", shortName = "vaadin-starter", iconPath = "images/logo-18.png", backgroundColor = "#233348", themeColor = "#233348")
...
public class MainLayout extends FlexBoxLayout
    ...
    public MainLayout(MenuCreator menuProvider, UICustomizer uiCustomizer, ErrorHandlerProvider errorHandlerProvider) {
        VaadinSession.getCurrent()
                .setErrorHandler(errorHandlerProvider.get());
        ...
        initStructure(uiCustomizer);

        // Populate the navigation drawer
        //initNaviItems();
        menuProvider.createMenu(naviDrawer.getMenu(), uiCustomizer);

        // Configure the headers and footers (optional)
        initHeadersAndFooters(uiCustomizer);
    }
     ...
     */
    private void initStructure(UICustomizer uiCustomizer) {
        naviDrawer = uiCustomizer.createNaviDrawer();
     ...
     */
    private void initHeadersAndFooters(UICustomizer uiCustomizer) {
        // setAppHeaderOuter();
        // setAppFooterInner();
        // setAppFooterOuter();
        ...
        appBar = uiCustomizer.createAppBar("");
